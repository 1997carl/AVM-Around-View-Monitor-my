...
images = glob.glob('D:/mypython/works/fisheye/step1_ub_fisheye/back/*.jpg')  #D:/mypython/works/fisheye/step1_ub_fisheye/front/front/ - frame at 0m41s.jpg
imgcnt=0
...
output_file = 'D:\\mypython\\works\\fisheye\\output\\calibration_data_back_1080p.yaml'
with open(output_file, 'w') as yaml_file:
    yaml.dump(calibration_data_back, yaml_file, default_flow_style=True)
...
panorama = cv2.imread('D:/mypython/works/fisheye/input/original_img/distorted_b.jpg') #D:/mypython/works/fisheye/measure_img/original_img/distorted_front.jpg
...
cv2.imwrite('D:/mypython/works/fisheye/step1_ub_fisheye/output/undistorted_back.jpg', planar_image)#修改保存路径