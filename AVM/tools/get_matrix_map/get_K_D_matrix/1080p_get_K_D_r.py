...
images = glob.glob('D:/mypython/works/fisheye/step1_ub_fisheye/right/*.jpg')  #D:/mypython/works/fisheye/step1_ub_fisheye/front/front/ - frame at 0m41s.jpg
imgcnt=0
for fname in images:
    ...
    if ret == True:
        ...
        output_dir = "D:/mypython/works/fisheye/step1_ub_fisheye/findcheekboard/"
...
output_file = 'D:\\mypython\\works\\fisheye\\output\\calibration_data_right_1080p.yaml'
with open(output_file, 'w') as yaml_file:
    yaml.dump(calibration_data_r, yaml_file)
...
#左视
#利用畸变参数，获得去畸变的图片，畸变参数可修改



# D:\mypython\works\fisheye\measure_img\original_img\1080p\distorted_r.jpg
panorama = cv2.imread('D:/mypython/works/fisheye/input/original_img/distorted_r.jpg') #D:/mypython/works/fisheye/measure_img/original_img/distorted_front.jpg
...
map1, map2 = cv2.fisheye.initUndistortRectifyMap(K_r, D_r, translation_matrix, K2_r, (int(height),int(width)), cv2.CV_16SC2)#修改为对应的参数
...
cv2.imwrite('D:/mypython/works/fisheye/step1_ub_fisheye/output/undistorted_right.jpg', planar_image)#修改保存路径