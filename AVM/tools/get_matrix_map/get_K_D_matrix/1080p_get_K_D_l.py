...
images = glob.glob('D:/mypython/works/fisheye/step1_ub_fisheye/left/*.jpg')  #D:/mypython/works/fisheye/step1_ub_fisheye/front/front/ - frame at 0m41s.jpg
imgcnt=0
for fname in images:
...
output_file = 'D:\\mypython\\works\\fisheye\\output\\calibration_data_left_1080p.yaml'
with open(output_file, 'w') as yaml_file:
    yaml.dump(calibration_data_l, yaml_file)
...
panorama = cv2.imread('D:/mypython/works/fisheye/input/original_img/distorted_l.jpg') #D:/mypython/works/fisheye/measure_img/original_img/distorted_front.jpg
...
map1, map2 = cv2.fisheye.initUndistortRectifyMap(K_l, D_l, translation_matrix, K2_l, (int(height),int(width)), cv2.CV_16SC2)#修改为对应的参数
...
cv2.imwrite('D:/mypython/works/fisheye/step1_ub_fisheye/output/undistorted_left.jpg', planar_image)#修改保存路径