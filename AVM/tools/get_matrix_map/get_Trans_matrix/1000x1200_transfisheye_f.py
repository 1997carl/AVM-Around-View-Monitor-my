...
print("get transimg")
image = cv2.imread(
    "D:/mypython/works/fisheye/step_2undistored/front/undistored_front.jpg"#D:\mypython\works\fisheye\step_2undistored\front\undistored_front.jpg
...
cv2.imwrite("D:/mypython/works/fisheye/step3_get_trans/front/before_transformed_image.jpg", image)
transformed_image = cv2.warpPerspective(image, transform_matrix, size)
cv2.imwrite("D:/mypython/works/fisheye/step3_get_trans/front/transformed_image_f.jpg", transformed_image)
...
output_file = 'D:/mypython/works/fisheye/step3_get_trans/front/transfor_front.yaml'
